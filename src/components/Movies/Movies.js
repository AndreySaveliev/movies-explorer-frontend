...
function Movies({searchMovie, shownMovies, showMore, handleSaveFilm, savMovies, searchByWord}) {
  ...
  return (
    <div className="movies">
      ...
      <MoviesCardList isSaved={false} shownMovies={shownMovies} handleSaveFilm={handleSaveFilm} savMovies={savMovies}/>
      <button
